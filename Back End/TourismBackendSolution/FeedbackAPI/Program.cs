...
// Add FeedbackContext to the container for dependency injection
...
builder.Services.AddScoped<IFeedbackRepo<FeedBack, int>, FeedbackRepo>();
builder.Services.AddScoped<IFeedbackService<FeedBack, int>, FeedbackService>();
